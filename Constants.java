package gov.dcra.filenet.constants;
...
public class Constants {
	...
	public static final String MSG_STANZA = "MSG_STANZA";
	public static final String MSG_DOMAIN = "MSG_DOMAIN";
	
	public static final String MSG_OBJECTSTORE_NAME = "MSG_OBJECTSTORE_NAME";
	public static final String MSG_EXPORT_DIR = "MSG_EXPORT_DIR";
	...
	//public static final String PROPERTY_DOCUMENT_TITLE = "1";
	//public static final String PROPERTY_XXX = "2";
}
